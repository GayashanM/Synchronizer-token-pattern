            ...
            if(isset($_COOKIE['session_cookie'])){
                ...
                if ($_POST['CSRF_token'] == $_SESSION['CSRF_Token']){
                    ...
                    echo "<ul class='list-group'>
                        ...
                        <li class='list-group-item list-group-item-secondary'>Your IT Number is ".$itnumber."</li>
                        <li class='list-group-item list-group-item-success'>Your Faculty is ".$faculty."</li>
